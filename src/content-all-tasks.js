...
export function createAllTasksContent() {
  ...
  function numberOfTasks() {
    const allTasks = document.querySelector('button.all-tasks')
    const tasksNumber = tasks.length;
    const tasksNumberNode = document.createTextNode(tasksNumber);
    ...
    allTasks.appendChild(tasksNumberWrap);
  ...
  tasksList.classList.add('tasks-list', 'all-tasks');
  ...
  return { tasksList, tasks, numberOfTasks };
}